    ...
    <form wire:submit.prevent="simpanPesanan" class="space-y-6">
        ...
        <div>
            ...
            <button type="button" wire:click="tambahItem"
                class="mt-3 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md font-medium">
                + Tambah Item
            </button>
        </div>
        ...
        <div class="flex justify-end gap-3 pt-4">
            ...
            <button type="submit"
                class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-semibold">
                Simpan Pesanan
            </button>
        </div>
    </form>
