                    ...
                    @if ($selectedPesanan->lokasiGPS)
                        <div class="mt-2 space-y-2">
                            ...
                            <button onclick="window.open('https://www.google.com/maps?q={{ $selectedPesanan->lokasiGPS }}', '_blank')"
                                class="mt-2 w-full bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white font-semibold py-2 rounded-lg shadow-md transition duration-200">
