...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        // Jumlah pesanan
        $this->pesananDiproses = Pesanan::where('statusPesanan', 'Diproses')->count();
        $this->pesananSelesai = Pesanan::where('statusPesanan', 'Selesai')->count();
        $this->totalPesanan = Pesanan::count();
