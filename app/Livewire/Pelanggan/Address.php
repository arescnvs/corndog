...
class Address extends Component
{
    ...
    private $lokasiToko = ['lat' => -6.294396589743022, 'long' => 106.73495834260528];
    ...
    public function setLokasi($lat, $long)
    {
        ...
        if ($this->jarakKeToko > 10) {
            $this->addError('lokasi', 'Lokasi Anda di luar jangkauan pengantaran (>10 km).');
        } else {
    ...
    public function konfirmasiAlamat()
    {
        ...
        if ($this->jarakKeToko !== null && $this->jarakKeToko > 10) {
